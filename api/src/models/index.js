...
exports.User.hasMany(exports.Conversation, { foreignKey: 'senderId', onDelete: 'CASCADE', hooks: true })
exports.User.hasMany(exports.Conversation, { foreignKey: 'receiverId', onDelete: 'CASCADE', hooks: true })
...
exports.Conversation.belongsTo(exports.User, { foreignKey: 'senderId' })
exports.Conversation.belongsTo(exports.User, { foreignKey: 'receiverId' })
